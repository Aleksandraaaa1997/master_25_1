...
function checkEvt(){
    var ev = window.performance.getEntriesByType("navigation")[0]
    var evTypep=window.performance.getEntriesByType("navigation")[0].type;

       if (evTypep=='reload'){
       var userResponse = window.alert('Vežba se prekida, molimo vas da ne osvežavate stranicu tokom izvršavaanja testa.');
