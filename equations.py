...
class Task_e1(Easy):
    ...
    def generate_variants(self):
        ...
        self.helps = ["Rešenje jednačine je broj koji zamenjen u jednačinu prevodi jednačinu u tačnu jednakost.<br>"
                      ...
                      f"U datoj jednačini poznati sabirak je {first_addend}. Zbir je {result}."]
        ...
        self.options = [f"{solution}",
                        f"{incorrect1_solution}",
                        f"{incorrect2_solution}"]
        random.shuffle(self.options)
        self.correct_answer = f"{solution}"
...
class Task_h1(Hard):
    ...
    def generate_variants(self):
        ...
        self.helps = ["Rešenje jednačine je broj koji zamenjen u jednačinu prevodi jednačinu u tačnu jednakost.<br>"
                      "Primeni pravilo za nepoznati sabirak koje nam govori da se nepoznati sabirak izračunava tako što se od zbira oduzme poznati sabirak.",
                      f"U datoj jednačini poznati sabirak je {fraction_first_addend}. Zbir je {fraction_result}.<br>"
                      f"Prilikom oduzimanja razlomaka potrebno je svesti ih na iste imenioce. <br>"
                      f"Imenilac zbira je duplo veći od imenioca poznatog sabirka, pa je potrebno poznati sabirak proširiti sa 2."]
        ...
        self.options = [f"{fraction_solution}",
                        f"{incorrect_solution}",
                        f"{fraction_incorrect_solution}"]
        random.shuffle(self.options)
        self.correct_answer = f"{fraction_solution}"
...
class Task_e2(Easy):
    ...
    def generate_variants(self):
        ...
        self.helps = ["Rešenje jednačine je broj koji zamenjen u jednačinu prevodi jednačinu u tačnu jednakost.<br>"
                      ...
                      f"U datoj jednačini umanjilac je {subtrahend}, dok je razlika {result}."]
...
class Task_h2(Hard):
    ...
    def generate_variants(self):
        while True:
            ...
            result = round(random.uniform(20.00, 30.00), 2)
...
class Task_e3(Easy):
    ...
    def generate_variants(self):
        ...
        self.helps = ["Rešenje jednačine je broj koji zamenjen u jednačinu prevodi jednačinu u tačnu jednakost.<br>"
                      ...
                      f"U datoj jednačini umanjenik je {minuend}, dok je razlika {result}."]
...
class Task_h3(Hard):
    ...
    def generate_variants(self):
        while True:
            ...
            result = round(random.uniform(10.00, 30.00), 2)
            ...
            if math.isclose(minuend, round(minuend, 2)) or math.isclose(result, round(result, 2)):
                break
...
def generate_equations_questions(number_of_questions,level):
    if level == "Lak":
